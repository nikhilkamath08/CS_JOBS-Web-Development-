...
public class UserController {
    ...
    public String admin(@RequestParam(required=false) String sea, ModelMap models )
    {
    	if(sea!=null)
    	{
    		System.out.println("hello"+sea);
    		models.put("jobs", jobDao.viewJob(sea));
    	}
    	else
    ...
    public String reviewer(ModelMap models,Authentication auth)
    {

    	models.put("displayjob",applicationDao.getAppli(((User) auth.getPrincipal()).getId()));
        return "reviewer";
    }
    
    @RequestMapping("/view.html")
    public String adminview(ModelMap models ,@RequestParam Long id)
    {
    	
    	models.put("disjob",jobDao.getJob(id));
